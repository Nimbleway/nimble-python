...
```sh
# install from this staging repo
pip install 'nimble_python[aiohttp] @ git+ssh://git@github.com/stainless-sdks/nimbleway-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/nimbleway-python/tree/main/src/nimble_python/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/nimbleway-python/tree/main/src/nimble_python/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
