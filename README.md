...
pip install git+ssh://git@github.com/Nimbleway/nimbleway-python.git
```
...
```sh
# install from the production repo
pip install 'nimbleway[aiohttp] @ git+ssh://git@github.com/Nimbleway/nimbleway-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/Nimbleway/nimbleway-python/tree/main/src/nimbleway/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/Nimbleway/nimbleway-python/tree/main/src/nimbleway/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/Nimbleway/nimbleway-python/issues) with questions, bugs, or suggestions.
