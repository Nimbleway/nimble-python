...
from ..types import extract_async_params, extract_extract_params
...
from ..types.extract_extract_response import ExtractExtractResponse
    ...
    def extract(
        ...
        *,
        ...
        return self._post(
            ...
            cast_to=ExtractExtractResponse,
        )
