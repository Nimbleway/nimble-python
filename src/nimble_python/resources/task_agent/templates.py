...
from ...types.task_agent import template_list_params
from ...types.task_agent.template_get_response import TemplateGetResponse
from ...types.task_agent.template_list_response import TemplateListResponse
...
class TemplatesResource(SyncAPIResource):
    ...
    def get(
        ...
        *,
        ...
        return self._get(
            path_template("/v1/task-agents/templates/{template_name}", template_name=template_name),
            options=make_request_options(
