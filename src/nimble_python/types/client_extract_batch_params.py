...
__all__ = [
    ...
    "Param",
    "ParamBrowser",
    "ParamBrowserUnionMember1",
    "ParamBrowserAction",
    "ParamCookiesUnionMember0",
    "ParamNetworkCapture",
    "ParamNetworkCaptureURL",
    "ParamSession",
    "SharedParams",
]
...
class ClientExtractBatchParams(TypedDict, total=False):
    params: Required[Iterable[Param]]
    """Array of extraction requests.

    Each object represents one extraction with its own parameters.
    """
...
class ParamBrowserUnionMember1(TypedDict, total=False):
...
ParamBrowser: TypeAlias = Union[Literal["chrome", "firefox"], ParamBrowserUnionMember1]

ParamBrowserAction: TypeAlias = Union[
    AutoScrollAction,
    ClickAction,
    EvalAction,
    FetchAction,
...
class ParamCookiesUnionMember0(TypedDict, total=False, extra_items=object):  # type: ignore[call-arg]
...
class ParamNetworkCaptureURL(TypedDict, total=False):
    value: Required[str]

    type: Literal["exact", "contains"]


class ParamNetworkCapture(TypedDict, total=False):
...
class ParamSession(TypedDict, total=False):
    id: str
...
class Param(TypedDict, total=False):
    ...
    browser_actions: Iterable[ParamBrowserAction]
    ...
    cookies: Union[Iterable[ParamCookiesUnionMember0], str]
    ...
    network_capture: Iterable[ParamNetworkCapture]
...
class SharedParams(TypedDict, total=False):
    """
    Shared parameters applied to the entire batch, such as storage and callback configuration.
    """
