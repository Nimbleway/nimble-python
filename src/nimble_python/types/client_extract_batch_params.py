...
__all__ = [
    "ClientExtractBatchParams",
    "Input",
    "InputBrowser",
    "InputBrowserUnionMember1",
    "InputBrowserAction",
    "InputCookiesUnionMember0",
    "InputNetworkCapture",
    "InputNetworkCaptureURL",
    "InputSession",
    "SharedInputs",
    "SharedInputsBrowser",
    "SharedInputsBrowserUnionMember1",
    "SharedInputsBrowserAction",
    "SharedInputsCookiesUnionMember0",
    "SharedInputsNetworkCapture",
    "SharedInputsNetworkCaptureURL",
    "SharedInputsSession",
]


class ClientExtractBatchParams(TypedDict, total=False):
    inputs: Required[Iterable[Input]]
    """Array of extraction requests.

    Each object can include extraction parameters and async/storage settings.
    """
...
class InputBrowserUnionMember1(TypedDict, total=False):
...
InputBrowser: TypeAlias = Union[Literal["chrome", "firefox"], InputBrowserUnionMember1]

InputBrowserAction: TypeAlias = Union[
    AutoScrollAction,
    ClickAction,
    EvalAction,
    FetchAction,
...
class InputNetworkCaptureURL(TypedDict, total=False):
    value: Required[str]

    type: Literal["exact", "contains"]


class InputNetworkCapture(TypedDict, total=False):
...
class InputSession(TypedDict, total=False):
    id: str
...
class Input(TypedDict, total=False):
    ...
    browser_actions: Iterable[InputBrowserAction]
    ...
    cookies: Union[Iterable[InputCookiesUnionMember0], str]
    ...
    network_capture: Iterable[InputNetworkCapture]
...
class SharedInputsBrowserUnionMember1(TypedDict, total=False):
    name: Required[Literal["chrome", "firefox"]]
...
SharedInputsBrowser: TypeAlias = Union[Literal["chrome", "firefox"], SharedInputsBrowserUnionMember1]

SharedInputsBrowserAction: TypeAlias = Union[
    AutoScrollAction,
    ClickAction,
    EvalAction,
    FetchAction,
...
class SharedInputsNetworkCaptureURL(TypedDict, total=False):
    value: Required[str]

    type: Literal["exact", "contains"]


class SharedInputsNetworkCapture(TypedDict, total=False):
    method: Literal["GET", "HEAD", "POST", "PUT", "DELETE", "CONNECT", "OPTIONS", "TRACE", "PATCH"]
...
class SharedInputsSession(TypedDict, total=False):
    id: str
...
class SharedInputs(TypedDict, total=False):
    ...
    browser_actions: Iterable[SharedInputsBrowserAction]
    """Array of browser automation actions to execute sequentially"""
    ...
    cookies: Union[Iterable[SharedInputsCookiesUnionMember0], str]
    """Browser cookies as array of cookie objects"""
    ...
    network_capture: Iterable[SharedInputsNetworkCapture]
    """Filters for capturing network traffic"""
