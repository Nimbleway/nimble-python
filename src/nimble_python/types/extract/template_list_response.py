...
__all__ = [
    ...
    "ItemPublishedVersionMetadata",
    "ItemPublishedVersionSample",
]


class ItemPublishedVersionMetadata(BaseModel):
...
class ItemPublishedVersionSample(BaseModel):
...
class ItemPublishedVersion(BaseModel):
    ...
    metadata: ItemPublishedVersionMetadata
    """Metadata associated with this version."""
    ...
    samples: Optional[List[ItemPublishedVersionSample]] = None
...
class Item(BaseModel):
    ...
    published_version: Optional[ItemPublishedVersion] = None
    """Published version details, when available."""
