...
__all__ = ["SerpRunBatchParams", "Input", "SharedInputs"]


class SerpRunBatchParams(TypedDict, total=False):
    inputs: Required[Iterable[Input]]
    """Array of SERP requests.

    Each object can include search parameters and async/storage settings.
    """

    shared_inputs: SharedInputs
    """Shared parameters applied to the entire batch.

    Can include search parameters and async/storage settings.
    """
