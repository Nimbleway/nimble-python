...
class CrawlResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> CrawlResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/Nimbleway/nimbleway-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> CrawlResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/Nimbleway/nimbleway-python#with_streaming_response
        """
