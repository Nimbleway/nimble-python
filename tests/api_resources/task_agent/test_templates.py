...
from nimble_python.types.task_agent import TemplateGetResponse, TemplateListResponse
...
class TestTemplates:
    ...
    def test_raw_response_list(self, client: Nimble) -> None:
        response = client.task_agent.templates.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Nimble) -> None:
        with client.task_agent.templates.with_streaming_response.list() as response:
    ...
    def test_raw_response_get(self, client: Nimble) -> None:
        response = client.task_agent.templates.with_raw_response.get(
            "template_name",
        )
    ...
    def test_streaming_response_get(self, client: Nimble) -> None:
        with client.task_agent.templates.with_streaming_response.get(
            "template_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_get(self, client: Nimble) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `template_name` but received ''"):
            client.task_agent.templates.with_raw_response.get(
                "",
            )
...
class TestAsyncTemplates:
    ...
    async def test_raw_response_list(self, async_client: AsyncNimble) -> None:
        response = await async_client.task_agent.templates.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncNimble) -> None:
        async with async_client.task_agent.templates.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_get(self, async_client: AsyncNimble) -> None:
        template = await async_client.task_agent.templates.get(
            "template_name",
        )
        assert_matches_type(TemplateGetResponse, template, path=["response"])
    ...
    async def test_raw_response_get(self, async_client: AsyncNimble) -> None:
        response = await async_client.task_agent.templates.with_raw_response.get(
            "template_name",
        )
    ...
    async def test_streaming_response_get(self, async_client: AsyncNimble) -> None:
        async with async_client.task_agent.templates.with_streaming_response.get(
            "template_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get(self, async_client: AsyncNimble) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `template_name` but received ''"):
            await async_client.task_agent.templates.with_raw_response.get(
                "",
            )
