...
class TestTasks:
    ...
    def test_method_list(self, client: Nimble) -> None:
        ...
        assert_matches_type(SyncCrawlPagination[TaskListResponse], task, path=["response"])
...
class TestAsyncTasks:
    ...
    async def test_method_list(self, async_client: AsyncNimble) -> None:
        ...
        assert_matches_type(AsyncCrawlPagination[TaskListResponse], task, path=["response"])
