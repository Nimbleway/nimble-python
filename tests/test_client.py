...
class TestNimble:
    ...
    def test_hardcoded_query_params_in_url(self, client: Nimble) -> None:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Nimble) -> None:
        respx_mock.post("/v2/extract").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.extract.with_streaming_response.run(url="url").__enter__()
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Nimble) -> None:
        respx_mock.post("/v2/extract").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v2/extract").mock(side_effect=retry_handler)

        response = client.extract.with_raw_response.run(url="url")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.extract.with_raw_response.run(url="url", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.extract.with_raw_response.run(url="url", extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncNimble:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncNimble) -> None:
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncNimble) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await async_client.extract.with_streaming_response.run(url="url").__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.extract.with_raw_response.run(url="url")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.extract.with_raw_response.run(
