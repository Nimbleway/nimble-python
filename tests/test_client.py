...
class TestNimble:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Nimble) -> None:
        respx_mock.post("/v1/map").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.with_streaming_response.map(url="url").__enter__()
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Nimble) -> None:
        respx_mock.post("/v1/map").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/v1/map").mock(side_effect=retry_handler)

        response = client.with_raw_response.map(url="url")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.with_raw_response.map(url="url", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.with_raw_response.map(url="url", extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncNimble:
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncNimble) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await async_client.with_streaming_response.map(url="url").__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.with_raw_response.map(url="url")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.with_raw_response.map(url="url", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.with_raw_response.map(url="url", extra_headers={"x-stainless-retry-count": "42"})
