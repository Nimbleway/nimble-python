...
class TestNimbleway:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Nimbleway) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.extract.with_streaming_response.create(url="https://example.com/page").__enter__()
    ...
    def test_retries_taken(
        ...
        response = client.extract.with_raw_response.create(url="https://example.com/page")
...
class TestAsyncNimbleway:
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.extract.with_streaming_response.create(url="https://example.com/page").__aenter__()
    ...
    async def test_retries_taken(
        ...
        response = await client.extract.with_raw_response.create(url="https://example.com/page")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.extract.with_raw_response.create(
            url="https://example.com/page", extra_headers={"x-stainless-retry-count": Omit()}
        )
